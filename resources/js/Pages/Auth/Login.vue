...
function adminSwitch() {
  form.isAdmin = form.isAdmin === 1 ? 0 : 1;
  form.username = "";
  form.password = "";
  form.errors = {};
}
...
<template>
  <GuestLayout>
    ...
    <form @submit.prevent="submit" class="space-y-3 sm:space-y-2">
      ...
      <!-- Username -->
      <div>
        <InputLabel class="text-[#3F444D] text-sm font-medium" for="username" value="Username/Pin/Email" />
        <TextInput
          id="username"
          type="text"
          ...
          required
          autofocus
          placeholder="Username/Pin/Email"
      ...
      <!-- Password -->
      <div>
        <InputLabel class="text-[#3F444D] text-sm font-medium" for="password" value="Password" />
        <div class="relative">
          <TextInput
            id="password"
        ...
        <div class="flex justify-end mt-2 sm:mt-3">
          <Link 
            ...
            class="forgot-password-link hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500/20 rounded px-2 py-1 transition-all duration-200 text-xs sm:text-sm"
          >
      ...
      <div class="w-full pt-3 sm:pt-2">
        <PrimaryButton
          class="cmBgDark px-6 w-full flex items-center justify-center h-10 sm:h-12 text-sm sm:text-base font-medium"
