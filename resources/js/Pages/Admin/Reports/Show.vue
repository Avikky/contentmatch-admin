          ...
          <div class="rounded-xl bg-white p-6 shadow-sm border border-slate-200">
            ...
            <div class="space-y-3">
              ...
              <button
                ...
                :disabled="processing"
                class="w-full rounded-lg bg-green-600 px-4 py-2 text-sm font-semibold text-white hover:bg-green-700 disabled:opacity-50"
              >
                Resolve Report
              </button>
              ...
              <button
                ...
                :disabled="processing"
                class="w-full rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 disabled:opacity-50"
              >
                Dismiss Report
              </button>
            </div>
        ...
        <form @submit.prevent="dismissReport">
          ...
          <div class="mt-6 flex gap-3">
            <button
              type="submit"
              :disabled="processing"
              class="flex-1 rounded-lg bg-slate-600 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-700 disabled:opacity-50"
            >
              Dismiss
            </button>
            <button
