          ...
          <form @submit.prevent="updateProfile" class="mt-6 space-y-4">
            ...
            <div class="flex items-center justify-between pt-2">
              ...
              <button
                ...
                class="ml-auto rounded-xl cmBgDark px-6 py-2.5 text-sm font-semibold text-white hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-slate-400 disabled:opacity-50"
              >
          ...
          <form v-if="showPasswordSection" @submit.prevent="updatePassword" class="mt-6 space-y-4">
            ...
            <div class="flex items-center justify-between pt-2">
              ...
              <button
                ...
                class="ml-auto rounded-xl bg-slate-900 px-6 py-2.5 text-sm font-semibold text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-400 disabled:opacity-50"
              >
