        ...
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div class="flex items-center justify-end gap-3 pt-6 border-t border-slate-200">
            ...
            <button
              ...
              class="px-6 py-2.5 rounded-xl bg-gradient-to-r from-[#14092A] to-[#2B0F4A] text-white text-sm font-semibold hover:opacity-90 transition disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              ...
              <span>{{ form.processing ? 'Creating Admin...' : 'Create Admin' }}</span>
            </button>
          </div>
        </form>
      </div>
